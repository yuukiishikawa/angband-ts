/**
 * @file generate/test-helpers.ts
 * @brief Shared test utilities for dungeon generation tests
 *
 * Provides a minimal feature info table that tests can use to enable
 * the square predicate functions (squareIsFloor, squareIsGranite, etc.).
 */
...
/**
 * Build and register a minimal feature info table for testing.
 *
 * Must be called in a beforeAll() block before any test that uses
 * square predicate functions.
 */
export function setupTestFeatureInfo(): void {
